...
export default function AnotherPage() {
  ...
  return (
    <Suspense fallback="loading">
      <Head>
        <title>Referenser | Artas Bygg</title>
        <meta
          name="description"
      ...
      <div>
        <header>
          <GlobalBaner
            classBackgroundSx={`url(${tloSx.src})`}
            header={
              <span
                style={{
                  color: "white",
                  backgroundColor: mobile ? "rgba(0,0,0,0.4)" : "none",
                  padding: "10px",
                }}
              >
                {t("about:realization_header")}
              </span>
            }
